    ...
    const DoctrineDecision& proposedDecision) const
{
    ...
    if (decision.type == DoctrineType::OpportunisticExpansion && weakCapability && fearful
        && summary.instability >= 0.20 && summary.instability < 0.30) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
    ...
    if (decision.type == DoctrineType::OpportunisticExpansion && traumatized && distrustsFederations
        && !weakCapability && !fearful) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
    ...
    if (decision.type == DoctrineType::OpportunisticExpansion && !summary.hegemonyDetected
        && !weakCapability && !fearful && summary.instability >= 0.45) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
    ...
    if (decision.type == DoctrineType::BalanceAgainstHegemon && traumatized && distrustsFederations
        && !summary.hegemonyDetected && summary.instability < 0.35) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
    ...
    if (decision.type == DoctrineType::BalanceAgainstHegemon && traumatized && distrustsFederations
        && !weakCapability && !fearful && !summary.hegemonyDetected && summary.instability >= 0.35
        && summary.instability < 0.45) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
    ...
    if (decision.type == DoctrineType::Consolidate && weakCapability && summary.hegemonyDetected && !fearful) {
        decision.type = DoctrineType::DefensivePosture;
        decision.rationale =
