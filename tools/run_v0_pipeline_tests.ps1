...
function Invoke-RealSessionTrendHandoffContinuityPriorityCase {
    ...
    Assert-Contains -Name "real session trend handoff continuity compare" -Text $compareText -Expected "real_session_v0_compare_entry_point_analysis_path_current="
    Assert-Contains -Name "real session trend handoff continuity compare" -Text $compareText -Expected "real_session_v0_compare_entry_point_readiness_current="
    ...
    Assert-Contains -Name "real session trend handoff continuity compare" -Text $compareText -Expected "real_session_v0_compare_entry_point_campaign_key_current="
    Assert-Contains -Name "real session trend handoff continuity compare" -Text $compareText -Expected "real_session_v0_compare_entry_point_empire_name_current="
    ...
    Assert-Contains -Name "real session trend handoff continuity" -Text $trendText -Expected "real_session_v0_trend_entry_point_analysis_path_current="
    Assert-Contains -Name "real session trend handoff continuity" -Text $trendText -Expected "real_session_v0_trend_entry_point_readiness_current="
    ...
    Assert-Contains -Name "real session trend handoff continuity" -Text $trendText -Expected "real_session_v0_trend_entry_point_campaign_key_current="
    Assert-Contains -Name "real session trend handoff continuity" -Text $trendText -Expected "real_session_v0_trend_entry_point_empire_name_current="
...
function Invoke-RealSessionWarningCodeDriftSurfaceCase {
    ...
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_state_current="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_state_previous="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_state_changed="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_reason_current="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_reason_previous="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mp_sync_transport_adapter_reason_changed="
    ...
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_reason_current="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_reason_previous="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_reason_changed="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_next_step_current="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_next_step_previous="
    Assert-Contains -Name "real session warning-code drift compare" -Text $compareText -Expected "real_session_v0_compare_friend_mesh_update_next_step_changed="
    ...
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_state_current="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_state_previous="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_state_changed="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_reason_current="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_reason_previous="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mp_sync_transport_adapter_reason_changed="
    ...
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_reason_current="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_reason_previous="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_reason_changed="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_next_step_current="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_next_step_previous="
    Assert-Contains -Name "real session warning-code drift trend" -Text $trendText -Expected "real_session_v0_trend_friend_mesh_update_next_step_changed="
...
function Invoke-RealSessionLoopMismatchForwardingCase {
    ...
    Assert-Contains -Name "real session loop mismatch forwarding compare" -Text $text -Expected "real_session_v0_loop_compare_auto_entry_point_analysis_path_current="
    Assert-Contains -Name "real session loop mismatch forwarding compare" -Text $text -Expected "real_session_v0_loop_compare_auto_entry_point_readiness_current="
    ...
    Assert-Contains -Name "real session loop mismatch forwarding compare" -Text $text -Expected "real_session_v0_loop_compare_auto_entry_point_campaign_key_current="
    Assert-Contains -Name "real session loop mismatch forwarding compare" -Text $text -Expected "real_session_v0_loop_compare_auto_entry_point_empire_name_current="
    ...
    Assert-Contains -Name "real session loop mismatch forwarding trend" -Text $text -Expected "real_session_v0_loop_trend_auto_entry_point_analysis_path_current="
    Assert-Contains -Name "real session loop mismatch forwarding trend" -Text $text -Expected "real_session_v0_loop_trend_auto_entry_point_readiness_current="
    ...
    Assert-Contains -Name "real session loop mismatch forwarding trend" -Text $text -Expected "real_session_v0_loop_trend_auto_entry_point_campaign_key_current="
    Assert-Contains -Name "real session loop mismatch forwarding trend" -Text $text -Expected "real_session_v0_loop_trend_auto_entry_point_empire_name_current="
    ...
    Assert-Contains -Name "real session loop mismatch forwarding output" -Text $text -Expected "real_session_v0_loop_friend_mesh_update_next_step="
    ...
    Assert-Contains -Name "real session loop mismatch forwarding evidence mesh update" -Text $evidenceText -Expected '"next_step"'
    Assert-Contains -Name "real session loop mismatch forwarding evidence adapter" -Text $evidenceText -Expected '"friend_mp_sync_transport_adapter"'
    ...
    Assert-Contains -Name "real session loop mismatch forwarding evidence entry point post play" -Text $evidenceText -Expected '"entry_point_campaign_key"'
    Assert-Contains -Name "real session loop mismatch forwarding evidence entry point post play" -Text $evidenceText -Expected '"entry_point_empire_name"'
...
function Invoke-RealSessionLoopMpSnapshotContractCase {
    ...
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_entry_point_reason="
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_entry_point_campaign_key="
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_entry_point_empire_name="
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_entry_point_count="
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_entry_point_branch_ambiguity="
    ...
    Assert-Contains -Name "real session loop mp snapshot contract output" -Text $text -Expected "real_session_v0_loop_memory_recovery_state_path="
    ...
    Assert-Contains -Name "real session loop mp snapshot contract evidence" -Text $evidenceText -Expected '"entry_point_campaign_key":'
    Assert-Contains -Name "real session loop mp snapshot contract evidence" -Text $evidenceText -Expected '"entry_point_empire_name":'
...
Assert-Contains -Name "snc friend mp sync transport adapter probe cli" -Text $sncFriendTransportAdapterProbeText -Expected "snc_friend_mp_sync_transport_adapter_state=ready_disabled"
...
$sncFriendInboxStageOutput = & $exePath `
    --stage-snc-friend-mp-sync-inbox `
    $sncFriendMpSyncEnvelopePath `
    $sncFriendMpSyncEncryptedPayloadPath `
    $sncFriendTransportAdapterPath `
    "false"
if ($LASTEXITCODE -ne 0) {
    throw "SNC friend MP sync inbox stage CLI failed. Actual output:`n$($sncFriendInboxStageOutput -join "`n")"
}
$sncFriendInboxStageText = $sncFriendInboxStageOutput -join "`n"
Assert-Contains -Name "snc friend mp sync inbox stage cli" -Text $sncFriendInboxStageText -Expected "snc_friend_mp_sync_inbox_stage_success=true"
Assert-Contains -Name "snc friend mp sync inbox stage cli" -Text $sncFriendInboxStageText -Expected "snc_friend_mp_sync_inbox_stage_state=staged_for_inbox"
Assert-Contains -Name "snc friend mp sync inbox stage cli" -Text $sncFriendInboxStageText -Expected "snc_friend_mp_sync_inbox_stage_stellaris_running=false"
Assert-Contains -Name "snc friend mp sync inbox stage cli" -Text $sncFriendInboxStageText -Expected "snc_friend_mp_sync_inbox_stage_directory=$sncFriendTransportAdapterPathText"
Assert-Contains -Name "snc friend mp sync inbox stage cli" -Text $sncFriendInboxStageText -Expected "snc_friend_mp_sync_inbox_stage_manifest_path="
$sncFriendInboxStageManifestPath = Join-Path $sncFriendTransportAdapterPath "snc_friend_mp_sync_inbox\campaign-mp-cli-001\overlay-v0-cli-001\snc-node-host-cli-001\snc-node-client-cli-001\snc_friend_mp_sync_transport_manifest.json"
if (-not (Test-Path -LiteralPath $sncFriendInboxStageManifestPath)) {
    throw "SNC friend MP sync inbox stage CLI did not write the transport manifest."
}
$sncFriendInboxStageManifestJson = Get-Content -LiteralPath $sncFriendInboxStageManifestPath -Raw
Assert-Contains -Name "snc friend mp sync inbox stage cli manifest" -Text $sncFriendInboxStageManifestJson -Expected '"stage_state": "staged_for_inbox"'
Assert-Contains -Name "snc friend mp sync inbox stage cli manifest" -Text $sncFriendInboxStageManifestJson -Expected '"campaign_id": "campaign-mp-cli-001"'
Assert-Contains -Name "snc friend mp sync inbox stage cli manifest" -Text $sncFriendInboxStageManifestJson -Expected '"overlay_version": "overlay-v0-cli-001"'
