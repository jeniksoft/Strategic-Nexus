...
| Metric | Value |
| --- | ---: |
| Weighted overall progress | 60% |
| Strict implementation complete | 46% |
| Implemented-or-better complexity | 46% |
| Verified-or-done complexity | 5% |
| Implemented-or-better items | 48% |
| Verified-or-done items | 6% |
| Roadmap items | 52 |
| Complexity points | 605 |
| Completed weighted points | 364.5 |
| Remaining weighted points | 241 |
