...
* A campaign folder is a dynamic save boundary, not a stable preselected target. SNC must rescan the whole `save games` tree because new campaigns can appear while SNC is already running.
